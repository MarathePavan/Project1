...
public class ExampleImageBlur extends JFrame {
  CPanel displayPanel;

  JButton sharpenButton, blurringButton, edButton, resetButton;

  public ExampleImageBlur() {
    super();
...
class CPanel extends JLabel {
  ...
  public void loadImage() {
    displayImage = Toolkit.getDefaultToolkit().getImage("C:\\Users\\Admin\\Desktop\\orsrc10157.jpg");
  ...
  public void blur() {
    float data[] = { 0.1625f, 0.125f, 0.1625f, 0.125f, 0.15f, 0.125f,
        0.56625f, 5.5425f, 2.43625f };
    Kernel kernel = new Kernel(3, 3, data);
    ConvolveOp convolve = new ConvolveOp(kernel, ConvolveOp.EDGE_NO_OP,
        null);
    convolve.filter(biSrc, biDest);
